                ...
                if (!is_uploaded_file($f['tmp_name'])) {
                    ...
                    if ($img_type === false || !array_key_exists($img_type, $allowed_image_types)) {
                        ...
                        if ($expected_mime && $mime !== $expected_mime) {
                            ...
                            $filename = sprintf('%s_%s.%s', $ts, $rand, $ext);
...
<head>
    ...
    <style>
        ...
        .box { border: 1px solid #ddd; padding: 12px; border-radius: 6px; max-width: 900px; }
        img { max-width: 100%; height: auto; }
        .gallery img { max-width: 200px; margin: 6px; border: 1px solid #ccc; padding: 3px; background: #fff; }
    </style>
</head>
<body>
<div class="box">
